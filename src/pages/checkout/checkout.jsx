...
function Checkout() {
    ...
    function FinalizarPedido() {
        ...
        // montar itens para enviar para API...
        ...
        localStorage.setItem("sessionUser", JSON.stringify(params)); // carrega os dados do formulario localmente para nao ter q digitar toda hora
    ...
    useEffect(()=>{
        if (localStorage.getItem("sessionUser")) {
            ...
            // carrega os dados do formulario localmente para nao ter q digitar toda hora
        ...
        <div className="container">
            ...
            <div className="col-3">
                <div className="box-checkout">
                    ...
                    <div className="input-group">
                        <p>Estado</p>
                        <select id="uf" name="uf" value={uf} onChange={(e)=>setUf(e.target.value)}>
                            <option value=""></option>
